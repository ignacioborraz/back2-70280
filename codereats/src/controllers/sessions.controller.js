...
const { createOne, readOne, readAll, updateOne, destroyOne, register, login, signout, onlineToken } = controller;
export { createOne, readOne, readAll, updateOne, destroyOne, register, login, signout, onlineToken };